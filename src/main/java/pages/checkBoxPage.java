...
public class checkBoxPage {
	...
	public boolean isCheckboxTitleDisplayed() {
		return elemUtils.displayStatusOfElement(imgCheckBox, CommonData.EXPLICIT_WAIT_BASIC_TIME);
	}
	...
	public boolean isdisCheckopt2Selected() {
		return elemUtils.isElementClicked(disCheckopt2, CommonData.EXPLICIT_WAIT_BASIC_TIME);
	}
	...
	public boolean isbtnCheckAllOpt2Selected() {
		return elemUtils.isElementClicked(btnCheckAllOpt2,CommonData.EXPLICIT_WAIT_BASIC_TIME );
	}
